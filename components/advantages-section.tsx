...
const advantages = [
  ...
  },
  {
    ...
    description:
      "Это портативный прибор, но он регистрирует все 6 отведений с медицинской точностью, как это делают стационарные кардиографы.",
  },
  {
    icon: Stethoscope,
  ...
  return (
    <section id="advantages" ref={ref as React.RefObject<HTMLElement>} style={style} className="relative overflow-x-hidden bg-slate-900 py-12 md:py-14">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -left-32 top-1/3 h-72 w-72 rounded-full bg-brand-teal/20 blur-3xl" />
        <div className="absolute -right-32 bottom-1/3 h-72 w-72 rounded-full bg-brand-cyan/20 blur-3xl" />
