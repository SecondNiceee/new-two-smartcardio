          ...
          <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
            ...
            <div className="relative max-w-xl px-12 py-8 lg:flex-1">
              ...
              <p className="mt-5 text-pretty text-lg leading-relaxed text-muted-foreground">
                Полноценное ЭКГ в 6 отведениях — как в медицинских учреждениях, но всегда под рукой. Компактный прибор снимает кардиограмму за считанные секунды, а удобное приложение мгновенно показывает результат и с помощью ИИ помогает распознать нарушения.
              </p>
